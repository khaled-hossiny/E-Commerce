      ...
      <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
        ...
        <div class="row tm-edit-product-row">
          <div class="col-xl-6 col-lg-6 col-md-12">
            <form action="/E_Commerce_1_0_SNAPSHOT_war/AddProduct" class="tm-edit-product-form" method="post"  enctype="multipart/form-data">
          ...
          <div class="col-xl-6 col-lg-6 col-md-12 mx-auto mb-4" id="back" style="position:absolute;top:30px;right:50px;">
            <div style="position:absolute;top:30px;right:50px; background-color: #f8694a;height: 200px;width: 300px;">
              ...
              <input type="file"  onchange="loadFile(event)" id="fileName" name="fileName" size="60" required>
...
<%--                      onclick="document.getElementById('fileName').click();">--%>
          ...
          <div class="col-12">
            <input type="submit" id="submit" class="btn btn-primary btn-block text-uppercase" value="Add Product Now">
          </div>
          </form>
        </div>
      </div>
