...
create table product( id int auto_increment primary key, name varchar(40) not null unique, description varchar(100) not null, quantity int not null, price int not null,image varchar(500) not null);
